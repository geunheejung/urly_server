...
export const getInsertUserQuery = (user: IUser) => {
  ...
  const values = `'${id}', '${password}', '${name}',	'${phone}', '${address}', '${detailAddress}',	'${gender}', '${birth}', '${additionalType}',	'${additionalValue}', '${requiredTermsCondition}', '${requiredTermsOfPrivacy}',	'${optionalTermsOfPrivacy}', '${signupEventAll}', '${optionalTermsOfSms}', '${optionalTermsOfMailing}','${requiredSignupAge}'`;
